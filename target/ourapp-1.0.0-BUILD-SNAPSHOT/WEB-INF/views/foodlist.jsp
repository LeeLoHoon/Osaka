...
<body id="food" data-spy="scroll" data-target=".navbar" data-offset="50">
	...
	<div class="w3-content" style="max-width: 1100px;">
		...
		<br> <br> <br>
		<div id="contain">
			<h1 align=center style="font-family: 'Nanum Gothic';">FOOD</h1>
			<br>
			<p align=center style="font-family: 'Nanum Gothic';">
				TripAndFood 중 Food 부분입니다.<br> 다른 분들께서 오사카를 여행하면서 방문하고 직접 기록한
				맛집들을 둘러보세요!<br> 오사카를 여행할 때 갔던 맛집이나 음식 사진들을 기록하고 공유하고 싶으신가요?<br>목록
				밑에 있는 버튼을 눌러 추억을 남겨보세요.
			</p>
			<br> <br> <input type="button" id="button2" value="맛집 작성하기"
			...
			<table id="popularlist" width="90%">
				...
				<c:forEach items="${foodlist}" var="u" varStatus="status">
					<tr>
						...
						<td width="30%" id="photo"><img src="${path}/resources/img/food${u.fid}.jpg" height=150px></td>
